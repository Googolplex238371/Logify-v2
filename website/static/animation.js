...
a = 0
setInterval(function(){if(window.navigator.onLine){document.getElementById("main").style.display="block";document.getElementById("ban").style.opacity = Math.abs(Math.sin(a)).toString();a+=Math.PI/135}},10)