...
def create_database(app):
    with app.app_context():
        ...
        if not path.exists('website/' + DB_NAME):
            ...
            teacher = User(email="teacher@gmail.com",password=generate_password_hash("Bobo@123",method="sha256"),name="Teacher",admin=False,teacher=True,verified=True,school="Nexus International School Singapore")
